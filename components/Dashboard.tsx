    ...
    <div className="flex flex-col gap-8 pb-10">
      ...
      <div className="bg-white p-10 rounded-5xl shadow-sm border border-gray-50 flex flex-col md:flex-row justify-between gap-10">
        <div className="flex-1">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">총 프로젝트 가치</p>
          ...
          <div className="flex items-center gap-2 text-xs font-bold text-gray-400">
            <span>이전 대비 ${(summaryStats.asset.value * 940).toLocaleString()}.00</span>
            <ChevronDown size={14} />
            <span className="ml-2">2024년 1월 1일 - 12월 31일</span>
          </div>
          
          {/* Sub progress bars */}
          <div className="mt-10 grid grid-cols-3 gap-10">
            {[
              { label: '자산 가치', val: summaryStats.asset.value, color: 'bg-black' },
              { label: '임대율', val: summaryStats.lease.rate, color: 'bg-blue-400' },
              { label: '안전 지수', val: summaryStats.safety.days, color: 'bg-pink-500' }
            ].map((bar, i) => (
        ...
        <div className="w-full md:w-80 flex flex-col gap-4">
          <div className="bg-gray-50/50 p-6 rounded-4xl border border-gray-100 flex items-center justify-between group cursor-pointer hover:bg-white transition-all">
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">최고 자산</p>
          ...
          <div className="bg-black p-6 rounded-4xl text-white flex items-center justify-between group cursor-pointer hover:scale-[1.02] transition-all">
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">최고 거래</p>
      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-12 lg:col-span-4 bg-white p-8 rounded-5xl shadow-sm border border-gray-50">
          ...
          <div className="space-y-6">
            {[
              ...
              { name: '임대 및 세대', val: '$142,823', pct: 27, color: 'text-blue-500' },
              { name: '자산 가치', val: '$89,935', pct: 11, color: 'text-black' },
        ...
        <div className="col-span-12 lg:col-span-8 bg-white p-8 rounded-5xl shadow-sm border border-gray-50 flex flex-col min-h-[400px]">
          <div className="flex items-center justify-between mb-8">
            <h3 className="font-bold text-lg">프로젝트 작업 활동</h3>
            <button 
